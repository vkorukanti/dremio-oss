 ...
 * by writer {@link NewRecordWriter}.
 */
public class NewRecordReader extends AbstractRecordReader {
  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(NewRecordReader.class);
  ...
  public NewRecordReader(final OperatorContext context, final FileSystemWrapper dfs, final Path path,
