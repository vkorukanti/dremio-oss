 ...
 */
@JsonTypeName("newFormat") @JsonInclude(JsonInclude.Include.NON_DEFAULT)
public class NewFormatPluginConfig implements FormatPluginConfig {
  ...
  public boolean equals(Object o) {
    ...
    final NewFormatPluginConfig that = (NewFormatPluginConfig) o;
