 ...
 */
package com.dremio.exec.store.easy.newformat;
 ...
 */
public class NewFormatPlugin extends EasyFormatPlugin<NewFormatPluginConfig> {
//  private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ArrowFormatPlugin.class);
   ...
   * @param fsPlugin
   */
  public NewFormatPlugin(final String name, final SabotContext context, final NewFormatPluginConfig formatConfig, final FileSystemPlugin fsPlugin) {
  ...
  public RecordReader getRecordReader(final OperatorContext context, final FileSystemWrapper dfs, EasyDatasetSplitXAttr splitAttributes, final List<SchemaPath> columns) throws ExecutionSetupException {
    ...
    return new NewRecordReader(context, dfs, path, columns);
  }
  ...
  public RecordWriter getRecordWriter(final OperatorContext context, final EasyWriter writer) throws IOException {
    return new NewRecordWriter(context, writer, (NewFormatPluginConfig) writer.getFormatConfig());
  }
