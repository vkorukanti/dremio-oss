 ...
 */
public class NewRecordWriter implements RecordWriter {
  ...
  public NewRecordWriter(OperatorContext context, final EasyWriter writerConfig, NewFormatPluginConfig formatConfig) {
